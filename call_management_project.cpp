...
#include<conio.h>  // through which users can interact with system programs,console input and output
#include<string.h> //string()
#include<iomanip>  //setfill() , setprecision() , and setw()
#include<iostream>  // basic input and output

using namespace std;//provides a scope to the identifiers,organize code into logical groups and to prevent
...
class contact
{
	...
	void create_contact()///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
            ...
            cout<<"Name: ";
            cin.ignore();//if a value is entered for second time we don't have to use it
            cin>>name;
...
void save_contact()
{
	...
	cont.create_contact();//object initialize
...
void show_all_contacts()//////////////LISTTTTT
{
	system("cls");
	 cout<<"\n\t\t================================\n\t\t\tLIST OF CONTACTS\n\t\t================================\n";
...
void display_contact(int num)/////////////////SEARCHING
{
	bool found;
	int ch;
